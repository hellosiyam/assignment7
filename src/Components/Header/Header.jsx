    ...
    return (
        ...
        <div className='w-11/12 md:max-w-7xl mx-auto relative py-[64px] max-md:py-8'>
            ...
            <div className='relative z-50 text-center'>
                ...
                <button className='px-3 py-2.5 lg:px-6 lg:py-5 text-white hover:bg-white hover:text-black bg-blue-500 lg:rounded-2xl rounded-xl text-[14px] lg:text-xl lg:font-bold font-semibold'  type="button">Claim Free Credit</button>
            </div>
        </div>
        </div>
    );
