        ...
        <div className="border-2 border-[#1313131A] p-6 rounded-4xl flex flex-col gap-5">
           ...
           <div className="flex flex-col gap-3 border-b-2 border-[#1313131A] pb-4">
            ...
            <div className="flex gap-2 items-center">
                ...
                <div className="text-[12px] lg:text-[14px] px-[16px] py-[9px] border-2 bg-blue-100 border-blue-500 rounded-3xl" type="button">{club}</div>
            </div>
           </div>
           ...
           <div className="flex justify-between items-center">
            ...
            <button className="text-[12px] lg:text-[14px] px-[16px] py-[9px] border-2 bg-blue-100 border-blue-500 rounded-3xl" type="button">Choose Player</button>
           </div>
           </div>
           </div>
        </div>
