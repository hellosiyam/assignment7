...
const Player = ({ player, buyHandel }) => {
    const { id, name, country, club, flag, position, footed, price, img } = player;
            ...
            <div className=" flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <button onClick={() => buyHandel(player)} className="text-[12px] lg:text-[14px] px-[16px] py-[9px] border-2 bg-blue-100 border-blue-500 hover:bg-blue-500 hover:text-white rounded-3xl transition-all ease-in-out cursor-pointer" type="button">Choose Player</button>
                    </div>
                </div>
            </div>
        </div>
