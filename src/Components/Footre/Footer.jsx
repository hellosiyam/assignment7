                ...
                <div className='flex flex-col lg:flex-row lg:justify-between max-sm:gap-5'>
                    ...
                    <div className='flex flex-col gap-4'>
                        ...
                        <div className='flex '>
                            ...
                            <button className='rounded-r-xl px-[16px] lg:px-[30px] py-[15px] text-base text-[#040D11] font-semibold bg-gradient-to-r from-[#D6C48F] via-[#F7CA69] to-[#EB868B] ... cursor-pointer hover:bg-blue-500 hover:text-white'>Subscribe</button>
                        </div>
                    </div>
                </div>
