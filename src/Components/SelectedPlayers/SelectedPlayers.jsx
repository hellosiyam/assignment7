        ...
        <div className="lg:max-w-7xl lg:mx-auto py-6 px-4 lg:px-0 lg:py-16 flex flex-col gap-8">
            <div className="flex flex-col lg:flex-row justify-between gap-2.5 lg:gap-0">
                ...
                <div className="border-2 border-[#1313131A] rounded-2xl">
                    <button className="py-[14px] px-[30px] rounded-l-2xl text-[#13131399] font-normal text-base hover:bg-blue-500 hover:text-white cursor-pointer" type="button" onClick={() => setSelected(false)}>Available</button>
                    <button onClick={selectedHandel} className="py-[14px] px-[30px] rounded-r-2xl text-white hover:bg-white hover:text-black bg-blue-500 text-base font-normal cursor-pointer" type="button">Selected ({selectPlayers.length})</button>
                </div>
            </div>
